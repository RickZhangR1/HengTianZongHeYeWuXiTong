        ...
        <div id="firstdiv" v-if="msg === 1">
            ...
            <div class="equ_div_fy1">
                <el-pagination
                        ...
                        :total="tableData.length">   <!--这是显示总共有多少数据， userList.length -->
                </el-pagination>
            </div>
...
<script>
    ...
    export default {
        ...
        mounted() {
            ...
            var roleid = this.$session.get("roleid");  //  00000000-0000-0000-0000-000000000000  admin
            ...
            if (roleid == 'admin') {
                ...
                this.axios.get("/pdf/pdf/findAllTb_ProcureAdmin").then(res => {
                ...
                this.axios.get("/pdf/pdf/findAllTb_Procure?roleid=" + roleid).then(res => {    //获取采购订单主表数据；
                    this.tableData = res.data.data;
              ...
              console.log(this.formSearch.fullname)
                ...
                if (start == 'Invalid date' && end == 'Invalid date' && this.formSearch.id1 == '' && this.formSearch.fullname == '' && this.formSearch.orderNo == '') {
                    ...
                    this.axios.get("/pdf/pdf/searchSelect1?startDate=" +start
                        + "&endDate=" +end+
                        "&bianhao=" + this.formSearch.id1 +
                        "&fullname=" + this.formSearch.fullname +
                        "&loginname=" + this.pubRoleid +
                        "&orderNo=" + this.formSearch.orderNo).then(res => {
